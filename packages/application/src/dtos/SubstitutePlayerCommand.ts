 ...
 */
export class SubstitutePlayerCommandValidationError extends ValidationError {
  constructor(message: string, field?: string, value?: unknown) {
    super(message, 'SubstitutePlayerCommandValidationError', field, value);
    // Ensure correct prototype chain for instanceof checks
    Object.setPrototypeOf(this, SubstitutePlayerCommandValidationError.prototype);
  }
}
...
export const SubstitutePlayerCommandValidator = {
  ...
  validateNotes(notes: string): void {
    CommonValidators.validateNotes(
      notes,
      (msg, field, value) => new SubstitutePlayerCommandValidationError(msg, field, value)
    );
  },
