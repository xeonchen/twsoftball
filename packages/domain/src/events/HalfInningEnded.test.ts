...
describe('HalfInningEnded', () => {
  ...
  describe('Construction', () => {
    ...
    it('should inherit DomainEvent properties', () => {
      const event = new HalfInningEnded(gameId, 1, false, 3);
    ...
    it('should create events with unique event IDs', () => {
      const event1 = new HalfInningEnded(gameId, 1, true, 3);
      const event2 = new HalfInningEnded(gameId, 2, false, 2);
    ...
    it('should set timestamp to current time', () => {
      ...
      const event = new HalfInningEnded(gameId, 1, true, 3);
  ...
  describe('GameId Validation', () => {
    it('should reject null gameId', () => {
      ...
      expect(() => new HalfInningEnded(null, 1, true, 3)).toThrow(
    ...
    it('should reject undefined gameId', () => {
      ...
      expect(() => new HalfInningEnded(undefined, 1, true, 3)).toThrow(
        new DomainError('GameId cannot be null or undefined')
      );
    });
  });
  ...
  describe('Inning Validation', () => {
    it('should accept positive inning values', () => {
      [1, 2, 7, 12, 100].forEach(inning => {
        expect(() => new HalfInningEnded(gameId, inning, true, 3)).not.toThrow();
      });
    });

    it('should reject inning less than 1', () => {
      expect(() => new HalfInningEnded(gameId, 0, true, 3)).toThrow(
        new DomainError('Inning must be 1 or greater')
      );

      expect(() => new HalfInningEnded(gameId, -1, true, 3)).toThrow(
        new DomainError('Inning must be 1 or greater')
      );
    });
    ...
    it('should reject non-number inning', () => {
      ...
      expect(() => new HalfInningEnded(gameId, 'invalid', true, 3)).toThrow(
        new DomainError('Inning must be a valid number')
      );
    });

    it('should reject NaN inning', () => {
      expect(() => new HalfInningEnded(gameId, NaN, true, 3)).toThrow(
        new DomainError('Inning must be a valid number')
      );
    });

    it('should reject non-finite inning', () => {
      expect(() => new HalfInningEnded(gameId, Infinity, true, 3)).toThrow(
    ...
    it('should reject non-integer inning', () => {
      expect(() => new HalfInningEnded(gameId, 1.5, true, 3)).toThrow(
  ...
  describe('Final Outs Validation', () => {
    it('should accept valid final outs (0-5)', () => {
      [0, 1, 2, 3, 4, 5].forEach(outs => {
        expect(() => new HalfInningEnded(gameId, 1, true, outs)).not.toThrow();
      });
    });

    it('should reject final outs less than 0', () => {
      expect(() => new HalfInningEnded(gameId, 1, true, -1)).toThrow(
        new DomainError('Final outs must be between 0 and 5')
      );
    });

    it('should reject final outs greater than 5', () => {
      expect(() => new HalfInningEnded(gameId, 1, true, 6)).toThrow(
        new DomainError('Final outs must be between 0 and 5')
      );

      expect(() => new HalfInningEnded(gameId, 1, true, 10)).toThrow(
        new DomainError('Final outs must be between 0 and 5')
      );
    });
    ...
    it('should reject non-number final outs', () => {
      // @ts-expect-error - Testing string validation
      expect(() => new HalfInningEnded(gameId, 1, true, 'invalid')).toThrow(
        new DomainError('Final outs must be a valid number')
      );
    });

    it('should reject NaN final outs', () => {
      expect(() => new HalfInningEnded(gameId, 1, true, NaN)).toThrow(
        new DomainError('Final outs must be a valid number')
      );
    });

    it('should reject non-finite final outs', () => {
      expect(() => new HalfInningEnded(gameId, 1, true, Infinity)).toThrow(
    ...
    it('should reject non-integer final outs', () => {
      expect(() => new HalfInningEnded(gameId, 1, true, 2.5)).toThrow(
  ...
  describe('Immutability', () => {
    it('should have properties defined as readonly (compile-time check)', () => {
      const event = new HalfInningEnded(gameId, 7, false, 2);
    ...
    it('should create new instances for different events rather than modify existing ones', () => {
      const event1 = new HalfInningEnded(gameId, 1, true, 3);
      const event2 = new HalfInningEnded(gameId, 2, false, 1);
  ...
  describe('Serialization', () => {
    it('should be serializable to JSON', () => {
      const event = new HalfInningEnded(gameId, 9, true, 2);
  ...
  describe('Edge Cases', () => {
    ...
    it('should work with different half-inning scenarios', () => {
      ...
      scenarios.forEach(scenario => {
        const event = new HalfInningEnded(gameId, scenario.inning, scenario.wasTop, scenario.outs);
    ...
    it('should handle typical game flow transitions', () => {
      ...
      const walkoffEnding = new HalfInningEnded(gameId, 7, false, 1);
  ...
  describe('Type Safety', () => {
    ...
    it('should handle boolean wasTopHalf parameter correctly', () => {
      ...
      const topHalfEvent = new HalfInningEnded(gameId, 1, true, 3);
      ...
      const bottomHalfEvent = new HalfInningEnded(gameId, 1, false, 3);
  ...
  describe('Business Context', () => {
    it('should capture complete half-inning state for event sourcing reconstruction', () => {
      const event = new HalfInningEnded(gameId, 5, true, 3);
