...
import { useGameStore, useGameUseCases, type GameData } from '../../../entities/game';
...
describe('HomePage Component', () => {
  ...
  beforeEach(() => {
    ...
    mockUseGameUseCases = vi.mocked(useGameUseCases);
    mockUseGameUseCases.mockReturnValue({
      isInitialized: true,
    });
  });
  ...
  describe('Game History Display and Interaction', () => {
    it('should show empty state when no game history', () => {
      // Mock localStorage to return no game history
