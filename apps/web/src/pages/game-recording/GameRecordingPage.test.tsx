...
import { useErrorRecovery } from '../../shared/lib/hooks/useErrorRecovery';
import { useNavigationGuard } from '../../shared/lib/hooks/useNavigationGuard';
import { useRecordAtBat } from '../../shared/lib/hooks/useRecordAtBat';
...
vi.mock('../../shared/lib/hooks/useRecordAtBat', () => ({
